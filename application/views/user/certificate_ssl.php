...
<div class="container2" id="blur">
    <div class="main-title">
        <p class="font-weight-bold">CERTIFICATE SSL / LICENSE EXPIRATION</p>
    </div>
          ...
          <div class="content">
            <form action="#">
              <div class="user-details">
                <div class="input-box">
                  <span class="details2">Add New Certificate</span>
                  <!-- <hr opacity= "0.5" width= "103%" color ="#cccccc"> -->
                  <br>
                  <br>
                  <span class="details">Name</span>
                  <input type="text" placeholder="Enter certificate" required>
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                  <span class="details">Expired Date</span>
